...
const struct _zip_err_info _zip_err_str[] = {
    { N, "No error" },
    { N, "Multi-disk archives not supported" },
    { S, "Renaming temporary file failed" },
    { S, "Closing archive failed" },
    { S, "Seek error" },
    { S, "Read error" },
    { S, "Write error" },
    { N, "CRC error" },
    { N, "Containing archive was closed" },
    { N, "No such file" },
    ...
    { N, "Invalid argument" },
    { N, "Not a valid archive" },
    { N, "Internal error" },
    { L, "Archive inconsistent" },
    { S, "Can't remove file" },
...
const struct _zip_err_info _zip_err_details[] = {
    ...
    { E, "invalid extra field" },
    { E, "invalid AES extra field" },
